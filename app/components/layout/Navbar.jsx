        ...
        >
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20">
              <Link href="/" className="flex items-center space-x-2 text-primary hover:text-greaser-red/80 transition-colors group">
                ...
                {user ? (
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56 bg-greaser-charcoal border-primary/50 text-greaser-cream" align="end" forceMount>
                      ...
                      <DropdownMenuItem onClick={() => router.push('/profile')} className="hover:bg-primary/20 focus:bg-primary/30">
                  ...
                  <Button onClick={() => router.push('/auth')} className="hidden md:inline-flex bg-gradient-to-r from-primary to-greaser-gold hover:from-greaser-gold hover:to-primary text-greaser-charcoal font-bold shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                    Login / Sign Up
                  </Button>
                )}
                    ...
                    <SheetContent side="left" className="w-[280px] bg-greaser-charcoal p-6 border-r border-primary/30">
                      <div className="flex flex-col space-y-6 mt-8">
                        ...
                        <div className="pt-4 border-t border-primary/30">
                          {!user && (
                             <Button onClick={() => { router.push('/auth'); setIsMobileMenuOpen(false); }} className="w-full bg-gradient-to-r from-primary to-greaser-gold hover:from-greaser-gold hover:to-primary text-greaser-charcoal font-bold shadow-md">
                              Login / Sign Up
                            </Button>
                          )}
                        </div>
